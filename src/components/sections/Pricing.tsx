        ...
        <div className="flex justify-center">
          ...
          >
            ...
            >
              ...
              <div
                className="flex items-center justify-center gap-2 py-2.5 text-[10px] font-bold tracking-widest uppercase text-background"
              ...
              <div className="p-7 md:p-9">
                ...
                <div className="text-center mb-6">
                  <div className="text-[9px] text-muted-foreground tracking-widest uppercase mb-2">One-time payment</div>
                  <div className="flex items-start justify-center gap-1">
                    <span className="text-xl font-serif text-primary mt-2">₹</span>
                    <span className="text-6xl font-serif font-bold text-primary leading-none tracking-tight">1499</span>
                  </div>
                  <div className="mt-2 text-xs text-muted-foreground">Inclusive of all taxes + free shipping</div>
                  <div className="mt-1 line-through text-muted-foreground/50 text-xs">₹2499</div>
                </div>

                {/* Features - optimized spacing */}
                <ul className="flex flex-col gap-2 mb-6">
                  {features.map((f) => (
                    <li key={f} className="flex items-center gap-2.5 text-[13px] text-foreground/90">
                ...
                <Button
                  size="lg"
                  className="w-full h-12 rounded-full text-sm font-semibold bg-primary hover:bg-primary/90 text-primary-foreground shadow-[0_0_30px_rgba(212,175,55,0.3)] hover:shadow-[0_0_50px_rgba(212,175,55,0.5)] transition-all duration-300 hover:scale-[1.02]"
                >
